...
export function MobileBottomBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-[color:var(--color-border)] bg-bg/90 backdrop-blur-xl md:hidden">
      <div className="grid grid-cols-3">
        ...
        <a
          href="/reserve"
          className="flex min-h-14 items-center justify-center gap-2 text-base text-gold"
        >
          <UtensilsCrossed className="h-4 w-4" />
          Reserve
        </a>
        <a href="/menu" className="flex min-h-14 items-center justify-center gap-2 text-base text-cream">
          <MenuSquare className="h-4 w-4 text-gold" />
          Menu
        </a>
      </div>
    </div>
