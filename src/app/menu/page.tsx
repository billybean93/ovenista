  ...
  return (
    <div className="pb-24 pt-32">
      <div className="container-shell">
        ...
        <div className="sticky top-20 z-20 mt-8 flex flex-wrap gap-3 rounded-full border border-[color:var(--color-border)] bg-bg/80 p-3 backdrop-blur-xl">
        ...
        <div className="mt-12 space-y-16">
          {menuCategories.map((category) => (
            <section key={category.id} id={category.id}>
              <h2 className="font-display text-6xl font-semibold leading-none tracking-[-0.02em] text-cream">{category.label}</h2>
                  ...
                  >
                    <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-display text-3xl text-gold">{item.price}</p>
                      </div>
                    </div>
                  </article>
                ))}
