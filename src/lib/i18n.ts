  ...
  en: {
    ...
    pages: {
      ...
      menu: {
        ...
        subheading: "Browse the latest printed menu pages or open the full PDF version.",
        pdfCta: "Open PDF Menu",
        pdfNote: "Latest PDF opens in a new tab.",
        notes: [
          "Menu images reflect the latest printed menu.",
  ...
  vi: {
    ...
    pages: {
      ...
      menu: {
        ...
        subheading: "Xem các trang menu in mới nhất hoặc mở trọn bộ PDF.",
        pdfCta: "Mở Menu PDF",
        pdfNote: "Bản PDF mới nhất sẽ mở ở tab mới.",
        notes: [
          "Hình ảnh menu hiển thị theo bản in mới nhất.",
